# -*- coding: utf-8 -*-
"""
Created on Fri Jul 21 18:28:50 2023
...
images = [f for f in os.listdir(file) if os.path.splitext(f)[-1] == '.png']


for coordinate_x in range(coo_x-2,coo_x+3):
    for coordinate_y in range(coo_y-2,coo_y+3):
        ...
        color_codes = [(153,204,255), (0,153,255),(0,255,102),(0,204,0),(0,153,0),(0,102,0),(255,255,51),(255,204,0),(255,153,0),(255,102,0),(255,0,0),(255,2,153),(153,51,204),(102,0,153),(152,152,102),(255,255,255),(254,254,254),(0,0,0),(105,105,105)]
        intensity_legend =('0.1-1','1-2.5','2.5-4','4-8','8-12','12-18','18-24','24-37','37-50','50-75','75-100','100-150','150-200','Above 200','0','No data (White)','No data (White)','No data (Black)','No data (Grey)')
        intensity_lower = (0.1,1,2.5,4,8,12,18,24,37,50,75,100,150,200,0,0,0,0,0)
        intensity_upper = (1,2.5,4,8,12,18,24,37,50,75,100,150,200,300,0,0,0,0,0)
        intensity_middle = (0.55,1.75,3.25,6,10,15,21,30.5,43.5,62.5,87.5,125,175,200,0,0,0,0,0)
        ...
        df_test.to_csv('graphs/'+'export_rainfall_hydrograph'+'_'+str(coordinate_x)+','+str(coordinate_y)+'.csv')
